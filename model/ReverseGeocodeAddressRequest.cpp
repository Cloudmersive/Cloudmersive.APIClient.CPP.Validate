...
void ReverseGeocodeAddressRequest::validate()
{
    // TODO: implement validation
}

web::json::value ReverseGeocodeAddressRequest::toJson() const
{
...
void ReverseGeocodeAddressRequest::fromJson(web::json::value& val)
{
...
void ReverseGeocodeAddressRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ReverseGeocodeAddressRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double ReverseGeocodeAddressRequest::getLatitude() const
{
    return m_Latitude;
}


void ReverseGeocodeAddressRequest::setLatitude(double value)
{
    m_Latitude = value;
    m_LatitudeIsSet = true;
}
bool ReverseGeocodeAddressRequest::latitudeIsSet() const
{
    return m_LatitudeIsSet;
}

void ReverseGeocodeAddressRequest::unsetLatitude()
{
    m_LatitudeIsSet = false;
}

double ReverseGeocodeAddressRequest::getLongitude() const
{
    return m_Longitude;
}


void ReverseGeocodeAddressRequest::setLongitude(double value)
{
    m_Longitude = value;
    m_LongitudeIsSet = true;
}
bool ReverseGeocodeAddressRequest::longitudeIsSet() const
{
    return m_LongitudeIsSet;
}

void ReverseGeocodeAddressRequest::unsetLongitude()
{
    m_LongitudeIsSet = false;
}
