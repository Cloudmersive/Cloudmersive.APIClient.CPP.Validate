...
IPAddressApi::IPAddressApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::shared_ptr<GeolocateResponse>> IPAddressApi::iPAddressPost(utility::string_t value)
{
    ...
    utility::string_t path = utility::conversions::to_string_t("/validate/ip/geolocate");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("IPAddressApi->iPAddressPost does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("IPAddressApi->iPAddressPost does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling iPAddressPost: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling iPAddressPost: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    {
        std::shared_ptr<GeolocateResponse> result(new GeolocateResponse());
